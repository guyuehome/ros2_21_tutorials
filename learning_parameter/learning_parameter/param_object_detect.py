...
class ImageSubscriber(Node):
  def __init__(self, name):
    ...
    self.declare_parameter('red_h_lower', '180')
    
  def apple_detect(self, image):
    upper_red[0] = int(self.get_parameter('red_h_upper').get_parameter_value().string_value)
    lower_red[0] = int(self.get_parameter('red_h_lower').get_parameter_value().string_value)
